package com.ironhack.proxyaccountservice.controller.dto;
...
public class StudentCheckingDTO {
    ...
    public StudentCheckingDTO(BigDecimal balanceAmount, Currency balanceCurrency, String secretKey, String status, Long primaryOwner, Long secondaryOwner) {
